...
if(LIBLZMA_INCLUDE_DIRS AND EXISTS "${LIBLZMA_INCLUDE_DIRS}/lzma/version.h")
	file(STRINGS "${LIBLZMA_INCLUDE_DIRS}/lzma/version.h" _LZMA_VERSION_MAJOR_DEFINE REGEX "#define[\t ]+LZMA_VERSION_MAJOR[\t ]+[0-9]+.*")
	string(REGEX REPLACE "#define[\t ]+LZMA_VERSION_MAJOR[\t ]+([0-9]+).*" "\\1" LZMA_VERSION_MAJOR "${_LZMA_VERSION_MAJOR_DEFINE}")
	file(STRINGS "${LIBLZMA_INCLUDE_DIRS}/lzma/version.h" _LZMA_VERSION_MINOR_DEFINE REGEX "#define[\t ]+LZMA_VERSION_MINOR[\t ]+[0-9]+.*")
	string(REGEX REPLACE "#define[\t ]+LZMA_VERSION_MINOR[\t ]+([0-9]+).*" "\\1" LZMA_VERSION_MINOR "${_LZMA_VERSION_MINOR_DEFINE}")
	file(STRINGS "${LIBLZMA_INCLUDE_DIRS}/lzma/version.h" _LZMA_VERSION_PATCH_DEFINE REGEX "#define[\t ]+LZMA_VERSION_PATCH[\t ]+[0-9]+.*")
